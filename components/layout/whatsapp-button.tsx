...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-24 md:bottom-6 right-4 z-[80] group"
    >
      {/* Pulse rings */}
      <span
        aria-hidden="true"
      ...
      <span
        aria-hidden="true"
        className="absolute -inset-1 rounded-full bg-[#25D366] opacity-20 blur-sm"
      />

      {/* Main button */}
      <span className="relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#25D366] text-white shadow-lg shadow-green-500/30 transition-transform group-hover:scale-110 group-active:scale-95">
